...
class Game extends Component {
  ...
  handleStartGame() {
    ...
    let a = 10;
    return ApiService.startGame(a).then(()=>{
  ...
  render() {
    ...
    const { user: { name, tip, refunfing,refund_tip, game } } = this.props;
          ...
          :
            <div className="container">
              <GameMat
                ...
                point_ai={ game.point_ai }
                aiHandCards={ game.hand_ai }
                aiName="DEALER"
                point_player={ game.point_player }
              ...
              <Resolution
                ...
                ai_point = {game.point_ai}
                player_point = {game.point_player}
              />
              <GameInfo
                deckCardCount={ game.deck.length }
                turn = {game.turn}
