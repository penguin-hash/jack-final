...
class ApiService {
  ...
  static startGame(a) {
    return takeAction("startgame", { username: localStorage.getItem("cardgame_account"),_current_tip:a });
  }

  static addtip(c) {
    return takeAction("addtip", { ownername: localStorage.getItem("cardgame_account"),username: c });
  }
  ...
  static changeturn(){
    return takeAction("changeturn", { username: localStorage.getItem("cardgame_account") });
  }
